namespace ROOT.CIMV2 {
    ...
    public class StdRegProv : System.ComponentModel.Component {
        ...
        public static bool CheckAccess(uint hDefKey, string sSubKeyName) {
            ...
            if ((IsMethodStatic == true)) {
                ...
                return System.Convert.ToBoolean(outParams.Properties["bGranted"].Value);
            }
            else {
        ...
        public static uint DeleteKeyTree(uint hDefKey, string sSubKeyName) {
            uint returnValue = 0;
            string[] sNames = EnumKey(hDefKey, sSubKeyName);
            if (sNames != null) {
                for (int index = 0; index < sNames.Length; index++) {
