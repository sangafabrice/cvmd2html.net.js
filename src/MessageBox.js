...
package cvmd2html {
  ...
  internal abstract class MessageBox {
    ...
    static var WARNING: MessageBoxImage = MessageBoxImage.Exclamation;

    /// <summary>The help message type.</summary>
    static var HELP: MessageBoxImage = MessageBoxImage.None;
    ...
    static function Show(message: String, messageType: MessageBoxImage): String {
