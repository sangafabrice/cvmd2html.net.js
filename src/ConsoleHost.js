...
package cvmd2html {
  ...
  internal abstract class ConsoleHost {
    ...
    static function Create(pwshExePath: String, pwshScriptPath: String) {
    ...
    static function StartWith(markdownPath: String) {
    ...
    private static function WaitForExit(pwshStartInfo: ProcessStartInfo) {
      ...
      pwshExe.add_OutputDataReceived((new ConsoleData()).HandleOutputDataReceived);
      ...
      function HandleOutputDataReceived(pwshExe: Object, e: DataReceivedEventArgs) {
        ...
        if (!String.IsNullOrEmpty(outData)) {
          ...
          if (outData.TrimEnd().EndsWith('?')) {
            ...
            pwshExe.StandardInput.WriteLine(MessageBox.Show(_overwritePromptText, MessageBox.WARNING));
            // Optional
