...
Example: 20480.")]
        ...
        public static uint Create(string CommandLine, System.Management.ManagementBaseObject ProcessStartupInformation) {
            ...
            if ((IsMethodStatic == true)) {
                ...
                return System.Convert.ToUInt32(outParams.Properties["ProcessId"].Value);
            }
            else {
                return System.Convert.ToUInt32(0);
            }
