...
package cvmd2html {
  ...
  internal abstract class Converter {
    ...
    static function Create(htmlLibraryPath: String, jsLibraryPath: String) {
    ...
    static function ConvertFrom(markdownPath: String) {
    ...
    private static function GetContent(filePath: String) {
      try {
