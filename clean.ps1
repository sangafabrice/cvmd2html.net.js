...
& {
  Get-ChildItem "$PSScriptRoot\*.js","$PSScriptRoot\*.html","$PSScriptRoot\*.ps*1","$PSScriptRoot\.gitignore","$PSScriptRoot\resource.rc" -Exclude snarkdown.js -Recurse | ForEach-Object {
